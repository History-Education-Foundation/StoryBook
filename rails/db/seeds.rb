...
if parent
  # Seed Deindividuation with high-fidelity content
  deindividuation = CivicTopic.find_or_create_by!(name: "Deindividuation", parent: parent)
  deindividuation.update!(
    subject: "Psychology",
    tagline: "Exploring how groups influence individual identity and behavior.",
  ...
  ["Social Influence"].each do |name|
    ...
    sub.update!(
      ...
      legacy: "Discussion: Have students write down or ponder their answers to the following, then discuss as a class:\n* (If there was an activity) How did you respond to the group activity, if not an active participant, how do you think you would have responded?\n* How do you act differently in group settings compared to when alone?\n* If someone in charge told you to do something you disagreed with, would you do it?\n* If you had two friends who wanted to do something differently than you do, would you do what they were doing or do your own thing?\nCollect responses and let students share before continuing.",
      main_ideas_heading: "Main Lesson: Concepts & Vocab",
      main_ideas: "Video: https://www.youtube.com/embed/UGxGDdQnC1Y\n\nMini-Lesson: VOCABULARY\nGo Over and Make Sure Students Understand the Following Terms:\n\nTerm: Social Influence: “the process by which individuals adapt their opinion, revise their beliefs, or change their behavior as a result of social interactions with other people”\n\nTerm: Normative Social Influence: “conformity to a group norms, expectations, or behaviors to fit in, gain approval, or avoid social rejection”\n\nTerm: Informative Social Influence: “conformity to a group norm brought about by a desire to be correct”\n\nTerm: Deindividuation: “an experiential state characterized by loss of self-awareness, altered perceptions, and a reduction of inner restraints that results in the performance of unusual and sometimes antisocial behavior.”\n\nTerm: Social Facilitation: “a social phenomenon in which being in the presence of others improves individual task performance”\n\nTerm: Social Loafing: “the tendency for individuals to expend less effort when working collectively than when working individually”\n\nTerm: Groupthink: “a psychological phenomenon where the desire for harmony or conformity within a group results in irrational or dysfunctional decision-making”",
      criticism_heading: "Deep Dive: Historical Experiments",
      criticism: "Activity: DEEP DIVE\nDo a Deep Dive of these terms by having students learn about their history and how they relate to everyday life.\n\n* Solomon Asch Line Experiment: Participants were placed in a group of fake participants (researchers) with the unambiguous group task of evaluating which line in Figure 1 matched Figure 2. Each fake participant outspokenly selected the wrong choice. The real participant, going last, often also selected the wrong choice to match the group’s response.\n\n* Stanley Milgram Obedience Experiment: Participants were told to give another fake participant (a researcher) electric shocks that consecutively increased in intensity for getting answers wrong. The fake participant would purposely get answers wrong. When the real participant hesitated to give the increased electric shock, an authority figure would tell them to continue. Two-thirds of participants listened to the authority figure and went to the maximum volt shock, despite their personal judgement.\n\n* Relating to Everyday Life: Explain how these terms relate to conformity, decision making, compliance, and obedience. Explain why these social tendencies happen, how to tell if it’s happening, and what one can do with this new information.\n\n* Additional Items Related to Social Influence:\n* Foot-in-the-Door Phenomenon: agreeing to a large request after initially agreeing to a small request\n* Door-in-the-Face Phenomenon: agreeing to a new request after denying a larger previous request\n* Foot-in-the-Mouth Phenomenon: agreeing to a request after developing a type of relationship with the requester",
      suggested_reading_heading: "Final Reflection & Readings",
      suggested_reading: "Discussion: BOOK CHAPTERS\nFor more in-depth information, read the following book chapters:\n* Wesley Schultz, P., Tabanico, J. J., & Rendón, T. (2011). Normative beliefs as agents of influence: Basic processes and real-world applications. In Attitudes and Attitude Change (pp. 385–410).\n* Mangal, S. K., & Mangal, S. (2023). Social influence. In Essentials of Social Psychology (1st ed., pp. 221–246). Routledge.\n\nDiscussion: FINAL DISCUSSION\nAfter learning about social influence, have students re-evaluate their discussion questions responses again:\n* How do you act differently in group settings compared to when alone?\n* If someone in charge told you to do something you disagreed with, would you do it?\n* If you had two friends who wanted to do something differently than you do, would you do what they were doing or do your own thing?",
      published: true,
      is_lesson_plan: true
    )
  end
